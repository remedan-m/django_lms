...
class CustomAccountManager(BaseUserManager):
    ...
    def create_superuser(self, email, username, first_name, contact, address, password=None, **other_fields):
        ...
        return self.create_user(email, username, first_name, contact, address, password, **other_fields)

    def create_user(self, email, username, first_name,contact, address, password=None, **other_fields):
